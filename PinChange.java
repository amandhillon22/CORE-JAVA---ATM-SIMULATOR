...
public class PinChange extends JFrame implements ActionListener {
    ...
    PinChange(String pinnumber) {
        ...
        change.setBounds(355, 485, 130, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == change) {
            try {
                ...
                String query2= "update login set pinnumber = '"+nrpin+"' where pinnumber = '"+pinnumber+"'";
                String query3= "update acctype set pinno = '"+nrpin+"' where pinno = '"+pinnumber+"'";
                ...
                setVisible(false);
                new Transactions(nrpin).setVisible(true);
